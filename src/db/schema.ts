...
export const UserDetails = pgTable('user_details', {
    ...
    groom_photo: varchar('groom_photo', { length: 255 }),
    bride_photo: varchar('bride_photo', { length: 255 }),
    groom_dad_name: varchar('groom_dad_name', { length: 100 }),
    bride_dad_name: varchar('bride_dad_name', { length: 100 }),
    groom_mum_name: varchar('groom_mum_name', { length: 100 }),
    bride_mum_name: varchar('bride_mum_name', { length: 100 }),
